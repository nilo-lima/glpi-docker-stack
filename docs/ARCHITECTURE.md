...
Stack composto por **5 containers de runtime** + **1 builder de backup**, todos em uma única instância Docker Compose, com **2 redes segregadas** e **5 volumes nomeados**.
